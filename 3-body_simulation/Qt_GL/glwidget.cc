...
void GLWidget::ajouteParticule(Particule const& p,bool aleatoire){
    s.ajouteParticule(p,aleatoire);
}
void GLWidget::ajouteParticule_tracable(Particule const& t,bool aleatoire){
    s.ajouteParticule_tracable(t,aleatoire);
}
